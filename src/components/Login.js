                ...
                <div className="col-12 col-md-6 col-lg-6 col-xl-5">
                  <div className="header-top-left">
                    <ul className="header-top-list">
                      <li>
                        <Link href="https://live.themewild.com/cdn-cgi/l/email-protection#8ae3e4ece5caeff2ebe7fae6efa4e9e5e7">
              ...
              <div className="col-md-6 col-lg-3">
                <div className="footer-widget-box about-us">
                  ...
                  <ul className="footer-contact">
                    ...
                    <li>
                      <Link href="https://live.themewild.com/cdn-cgi/l/email-protection#fe97909891be9b869f938e929bd09d9193">
                        <i className="far fa-envelope" />
                        <span
                          className="__cf_email__"
                          data-cfemail="026b6c646d42677a636f726e672c616d6f"
                        >
                          [email&nbsp;protected]
                        </span>
                      </Link>
